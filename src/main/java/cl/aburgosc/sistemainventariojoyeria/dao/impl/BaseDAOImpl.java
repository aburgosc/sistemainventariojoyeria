...
public abstract class BaseDAOImpl<T> implements BaseDAO<T> {
    ...
    public int insertar(T obj) throws DAOException {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement ps = conn.prepareStatement(sql, new String[]{"id"})) {
    ...
    public void actualizar(T obj) throws DAOException {
        ...
        String sql = "UPDATE " + nombreTabla + " SET " + setPart + " WHERE " + pkField.getAnnotation(DBColumn.class).nombre() + "=?";
    ...
    public T obtenerPorId(int pk) throws DAOException {
        ...
        String sql = "SELECT " + columnas + ", " + pkField.getAnnotation(DBColumn.class).nombre()
                + " FROM " + nombreTabla + " WHERE " + pkField.getAnnotation(DBColumn.class).nombre() + "=?";
    ...
    public List<T> listar() throws DAOException {
        ...
        String sql = "SELECT " + columnas + ", " + pkField.getAnnotation(DBColumn.class).nombre() + " FROM " + nombreTabla;
    ...
    public String obtenerNombreTabla(Class<?> clazz) {
